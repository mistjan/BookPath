...
const gateways = [
  ...
  { title: "适合新手的经典", href: "/beginner", text: "难度 2 及以下的作品，适合刚接触文学阅读的读者。" },
  { title: "古典文学", href: "/classics", text: "从诗经到荷马，从红楼梦到源氏物语——按难度分级推荐的古典文学入门。" },
  { title: "随机推荐", href: "/start", text: "不知道读什么？选方向、定难度，帮你想。" }
];
